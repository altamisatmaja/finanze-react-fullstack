                  ...
                  <div className="text-white mt-4 lg:pr-4">
                    <ul className="space-y-6 tracking-wide font-medium text-sm md:flex md:space-y-0">
                      <li>
                        <a
                          href="#"
                          className="block text-xl md:px-4 rounded-lg mr-5 bg-blue-600 py-3 px-5 transition hover:text-yellow-300"
                        >
                          <span>Beranda</span>
                        </a>
                      </li>
                      <li>
                        <a
                          href="#"
                          className="block text-xl md:px-4 rounded-lg text-slate-900 bg-white border-2 border-solid border-slate-800 py-3 px-5 transition hover:text-yellow-300"
                        >
                          <span>Dashboard</span>
                        </a>
                      </li>
