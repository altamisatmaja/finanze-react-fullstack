...
function Laporan() {
  ...
  const datapemasukan = datakeuangan.filter(data => data.jenis === 'Pemasukan');
  const datapengeluaran = datakeuangan.filter(data => data.jenis === 'Pengeluaran');
            ...
            <div className="px-4">
               ...
               <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                     <div className="mb-4 flex items-center justify-between">
                        <div>
                           <h3 className="text-xl font-bold text-gray-900 mb-2">Latest Keterangans</h3>
                           <span className="text-base font-normal text-gray-500">This is a list of latest Keterangans</span>
                        </div>
                     </div>
