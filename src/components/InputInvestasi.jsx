          ...
          <form action="" className='' onSubmit={handleSubmit}>
            <div className='flex mt-2 justify-between'> 
              <div className='px-2'>
                ...
                <input value={durasiinvestasi} onChange={e => durasiinvestasichange(e.target.value)} required type="text" className='border w-56 rounded-md px-2 h-10 text-sm font-medium border-blue-200'/>
              </div>
              <div className='px-2'>
              ...
              <div className='px-2'>
                ...
                <input value={lot} onChange={e => lotchange(e.target.value)} required type="text" className='border w-full rounded-md px-2 h-10 text-sm font-medium border-blue-200'/>
              </div>
            </div>
            <div className='flex px-2 items-center justify-between'>
              ...
              <div className='px-2'>
                ...
                <input value={hargabeli} onChange={e => hargabelichange(e.target.value)} required type="text" className='border w-full rounded-md px-2 h-10 text-sm font-medium border-blue-200'/>
              </div>
              <div className='px-2'>
                <p className='text-lg font-medium'>Harga Jual</p>
                <input value={hargajual} onChange={e => hargajualchange(e.target.value)} required type="text" className='border w-full rounded-md px-2 h-10 text-sm font-medium border-blue-200'/>
              </div>
              <div className='mr-20'>
                <p className='text-lg font-medium'>Persentase</p>
                <input value={persentase} onChange={e => persentasechange(e.target.value)} required type="text" className='border w-full rounded-md px-2 h-10 text-sm font-medium border-blue-200'/>
              </div>
              <div className='flex py-7'>
                <button onClick={Bersihkan} type='submit' className='bg-blue-900 h-10 w-24 rounded-lg px-2 mr-2 text-sm font-semibold text-white'>Bersihkan</button>
                <button onClick={(e) => handleSubmit(e)} type='submit' className='bg-blue-700 h-10 w-52 rounded-lg px-1 mr-2 text-sm font-semibold text-white'>Tambah Pemasukan</button>
              </div>
              </div>
            </div>
          </form>
